...
from hummingbot.connector.exchange.nonkyc.nonkyc_utils import (
    convert_fromiso_to_unix_timestamp,
)
...
class NonkycOrderBook(OrderBook):
    ...
    def diff_message_from_exchange(
        ...
        formatted_asks = [
            [ask["price"], str(ask["quantity"])] for ask in orderbookdata["asks"]
        ]
        formatted_bids = [
            [ask["price"], str(ask["quantity"])] for ask in orderbookdata["bids"]
        ]
        ...
        return OrderBookMessage(
            ...
            {
                "trading_pair": msg["trading_pair"],
                "update_id": convert_fromiso_to_unix_timestamp(
